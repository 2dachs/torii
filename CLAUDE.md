...
- **設定保存バグ修正・ライセンス表示改善**:
  ...
  - 設定画面ライセンスセクション: β版中は「🎉 β版公開中 — 全Pro機能が無料」の表示に変更。β版終了後はPro版（¥980/月）が必要な旨も記載。
  - ホーム画面Pro CTA: β版中は「β版公開中 — 全機能が無料でご利用いただけます」のメッセージを表示。
...
| 購入URL | https://torii-dev.lemonsqueezy.com/buy/1679529 |
| Stripe審査 | 申請済み（審査中） |
| GitHubアカウント | 2dachs |
